...
/* 
 ...
 putting blocks back in, makes the code cleaner and easier to use, mingw isn't a thing anymore and I imagine
 its 64bit replacement is much better with clang now, might play w/ that later.
